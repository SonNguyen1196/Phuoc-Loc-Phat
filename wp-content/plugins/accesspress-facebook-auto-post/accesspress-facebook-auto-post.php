...
/**
 * Plugin Name: AccessPress Social Auto Post Lite
    ...
    class AFAP_Class {
      ...
      function asap_get_user_data($access_token, $asap_facebook_api){
        ...
        function afap_admin_menu() {
            add_menu_page(__('AccessPress Social Auto Post Lite', 'accesspress-facebook-auto-post'), __('AccessPress Social Auto Post Lite', 'accesspress-facebook-auto-post'), 'manage_options', 'afap', array($this, 'plugin_settings'),'dashicons-facebook-alt');
        }
        ...
        function add_afap_meta_box($post_type) {
            add_meta_box(
                    'afap_meta_box'
                    , __('AccessPress Social Auto Post Lite', 'accesspress-facebook-auto-post')
