=== AccessPress Social Auto Post Lite - Auto Post WordPress Plugin For Facebook Profile/Fan Pages ===
...
Auto Publish WordPress posts/pages/custom post types to your Facebook Profile and Fan pages.

== Description ==

<strong> ★ Important Note: This plugin is replacement of AccessPress Facebook Auto Post Plugin. Only Plugin Name has been changed.</strong> 
...
<strong>AccessPress Social Auto Post Lite</strong> is a FREE WordPress plugin for auto post to your facebook account. You can use this to publish your site's posts,pages and custom post types to your facebook profile and fan pages as soon as you hit the publish button in your site.
...
* <strong>Auto post on your facebook profile and fan pages</strong>
...
== Changelog ==
= 2.0.4 = 
* Plugin Name Changed to AccessPress Social Auto Post Lite however this plugin will currently only works for facebook auto post as earlier.

= 2.0.3 = 
* Resolve the error message shown while editing Appearances menus page due to our plugin.
* Latest WordPress Version Compatible Checked.
